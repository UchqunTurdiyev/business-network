				...
				<div className='g-6 flex h-full flex-wrap items-center justify-center lg:justify-between'>
					...
					<div className='mb-12 md:mb-0 md:w-8/12 lg:w-5/12 xl:w-5/12'>
						<form>
							...
							{/* <!-- Email input --> */}
							<div className='relative mt-6 mb-6' data-te-input-wrapper-init>
								<input
									type='text'
									value={email}
							...
							<div className='relative mb-6' data-te-input-wrapper-init>
								...
								<div className='absolute right-3 top-4 cursor-pointer'>
									{showPassword ? (
										<FaEye fontSize={'20px'} onClick={() => setShowPassword(prev => !prev)} />
									) : (
										<FaEyeSlash fontSize={'20px'} onClick={() => setShowPassword(prev => !prev)} />
									)}
								</div>
							</div>
						...
						<Text display={'felx'} alignItems={'center'} pt={10}>
							<span className='text-gray-500'>If you are not registered/ </span>
							<Link href={'/register'} textColor={'gray.100'}>
								SignUp
							</Link>
						</Text>
					</div>
